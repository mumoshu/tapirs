...
ci/test-s3:
	...
	AWS_ACCESS_KEY_ID=minioadmin AWS_SECRET_ACCESS_KEY=minioadmin \
	  ...
	  cargo test --release -- s3backup remote_store::tests::test_auto_flush remote_store::tests::test_read_replica remote_store::tests::test_e2e_s3 remote_store::tests::test_stores_from_s3 remote_store::tests::test_writable_clone remote_store::tests::test_read_replica_shim remote_store::tests::test_clone_with_snapshot remote_store::tests::test_clone_prepared \
