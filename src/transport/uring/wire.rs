...
pub(crate) enum WireMessage<U: ReplicaUpcalls> {
    Request {
        ...
        request_id: u64,
        #[serde(bound(
            serialize = "<U as ReplicaUpcalls>::UO: Serialize, <U as ReplicaUpcalls>::UR: Serialize, <U as ReplicaUpcalls>::IO: Serialize, <U as ReplicaUpcalls>::CO: Serialize, <U as ReplicaUpcalls>::CR: Serialize",
            deserialize = "<U as ReplicaUpcalls>::UO: Deserialize<'de>, <U as ReplicaUpcalls>::UR: Deserialize<'de>, <U as ReplicaUpcalls>::IO: Deserialize<'de>, <U as ReplicaUpcalls>::CO: Deserialize<'de>, <U as ReplicaUpcalls>::CR: Deserialize<'de>"
        ))]
