...
**P3 -- Related docs:** For how replicas participate in consensus, see [Protocol](../learn/internals/protocol-tapir.md). For single-node mode, see [Getting Started (solo)](getting-started-testbed-solo.md). Back to [tapi](cli-tapi.md).
